...
# '__weakref__', '_enabled', '_removed', 'callback', 'context', 
# 'enabled', 'from_aps_job', 'job', 'job_queue', 'name', 'next_t', 'removed', 
# 'run', 'schedule_removal']
# print(dir(context.job.job))
# ['__class__', '__delattr__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__getstate__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__setstate__', '__sizeof__', '__slots__', '__str__', '__subclasshook__', '__unicode__', '_get_run_times', '_jobstore_alias', '_modify', '_scheduler', 
# 'args', 'coalesce', 'executor', 'func', 'func_ref', 'id', 'kwargs', 
# 'max_instances', 'misfire_grace_time', 'modify', 'name', 
# 'next_run_time', 'pause', 'pending', 'remove', 'reschedule', 
# 'resume', 'trigger']
